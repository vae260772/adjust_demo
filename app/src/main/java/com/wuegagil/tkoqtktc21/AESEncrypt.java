package com.wuegagil.tkoqtktc21;//package com.wuegagil.tkoqtktc21;
...
public class AESEncrypt {
    private final static String AESENCRYPTKEY = "asdsadqw1890hjip"; // 替换成真实key,必须16位,自己随机设置一个
     ...
     *
     * @param data 待加密内容
     *             secretKey 加密密码，长度：16 或 32 个字符
     * @return 返回Base64转码后的加密数据
     */
    public static String encrypt(String data) {
        String secretKey = AESENCRYPTKEY;
        ...
        try {
            ...
            String base64Encode = base64Encode(encryptByte);

            Log.d(TAG, data + ",加密:" + base64Encode);
     ...
     *                   secretKey  解密的密钥，长度：16 或 32 个字符
     */
    public static String decrypt(String base64Data) {
        ...
        try {
            ...
            String decrypt = new String(result, CHARSET_UTF8);
            Log.d(TAG, base64Data + ",解密:" + decrypt);
